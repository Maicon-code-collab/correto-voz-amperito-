...
export class GdmLiveAudioVisuals extends LitElement {
  ...
  // FIX: LitElement lifecycle methods should be protected to correctly override the base class.
  ...
  // FIX: The render method must be protected to override the LitElement base class method.
  protected render() {
